...
void main() {
  group('GitCliStatusReader malformed-record guards', () {
    test('truncated "1" record is skipped instead of crashing', () async {
      ...
      final reader = GitCliStatusReader(
        _CannedRunner(
          [
            '# branch.head master',
            '1 .M',
    ...
    test(
      'truncated "2" rename record is skipped instead of crashing',
      () async {
        final reader = GitCliStatusReader(
          _CannedRunner(
            [
    ...
    test(
      'truncated "u" unmerged record is skipped instead of crashing',
      () async {
        final reader = GitCliStatusReader(
          _CannedRunner(
            [
    ...
    test('record with empty XY field is skipped instead of crashing', () async {
